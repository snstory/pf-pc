	...
	<table class="tb_def">
		...
		<tbody class="tds_01">
			...
			<tr class="focus">
				...
				<td class="lt"><a href="cmu_03_view.asp">[회의록]2010.06.20 전체 연구원 회의록</a></td>
				<td>관리자</td>
				<td>2010.06.20</td>
				<td>111</td>
			</tr>
			...
			<tr>
				<td>9</td>
				<td class="reply">
					<a href="cmu_03_view.asp">[회의록]2010.06.20 전체 연구원 회의록</a>
					<!-- 비밀글인 경우 아이콘 추가 -->
					<img src="../images/icons/lock.gif" alt="" class="scrt" />
				</td>
				<td>관리자</td>
				<td>2010.06.20</td>
				<td>111</td>
...
<div class="pazing">
	...
	<a href="cmu_03_write.asp" class="btn_gt"><img src="../images/btns/write.gif" alt="글쓰기" /></a>
</div>
<!-- //pazing -->
