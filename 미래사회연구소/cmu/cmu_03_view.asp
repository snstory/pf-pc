...
<div class="bs_01">
	...
	<ul class="vw_info_list">
		...
		<li>
			<dl class="vw_info">
				<dt><strong><img src="../images/txt/wtr_b.gif" alt="작성자" /></strong></dt>
				<dd class="cmn_02">홍길동</dd>
...
<!-- 버튼영역 -->
<div class="cmn_01">
	<a href="cmu_03_write.asp"><img src="../images/btns/reply_2.gif" alt="답글" /></a>
	<a href="cmu_03_write.asp"><img src="../images/btns/edit.gif" alt="수정" /></a>
	<a href="#"><img src="../images/btns/del.gif" alt="삭제" /></a>
	<a href="cmu_03.asp"><img src="../images/btns/list.gif" alt="목록" /></a>
</div>
<!-- //버튼영역 -->
