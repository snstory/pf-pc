		...
		<tbody>
			...
			<tr>
				...
				<td class="ttle">
					...
					<a href="teacher_04_view.asp">안녕하세요. 김민경 입니다.</a>
			...
			<tr class="reply">
				<td>1</td>
				<td class="ttle">
					<a href="teacher_04_view.asp">김민경씨 안녕하세요.^^</a>
					<img src="/images/common/icons/new_02.gif" alt="" class="new" /><!-- 새글일경우 -->
				</td>
				<td>관리자</td>
				<td>10. 01. 29</td>
			...
			<tr>
				<td>2</td>
				<td class="ttle"><a href="teacher_04_view.asp">안녕하세요. 김민경 입니다.</a></td>
				<td>관리자</td>
				<td>10. 01. 29</td>
				<td>922</td>
			</tr>
...
<div class="bbsPaz bbsPaz_pd02">
	...
	<div class="bbsBtns_02">
		<a href="teacher_04_write.asp"><img src="/images/common/btns/write.gif" alt="글쓰기" /></a>
	</div>
	<!-- //버튼영역 (페이징 영역용) -->
</div>
<!-- //페이징 -->
