...
pathArr(1,0) = "UCC마당"
pathArr(1,1) = "/talk/talk_01_01_list.asp"
pathArr(2,0) = "포토겔러리"
pathArr(2,1) = ""

titleImgSrc = "/images/talk/s_title_01_02.gif"
titleImgMent = "포토겔러리"
%>
...
<div class="tk01">
	<div class="tk01_wp">
		<ul class="tk01_ul">
			<li>
				<div class="wp">
					<div class="pic"><a href="talk_01_02_view.asp"><img src="../images/common/test_img/ucc_s_01.jpg" width="140" height="103" alt="" /></a></div>
					<h3 class="title"><a href="talk_01_02_view.asp"><strong>[New]</strong> 퍼팅 동영상</a></h3>
			...
			<li>
				<div class="wp">
					<div class="pic"><a href="talk_01_02_view.asp"><img src="../images/common/test_img/ucc_s_02.jpg" width="140" height="103" alt="" /></a></div>
					<h3 class="title"><a href="talk_01_02_view.asp"><strong class="best">[Best]</strong> 퍼팅 동영상</a></h3>
					<p class="hit">HIT : 2162</p>
					<p class="wtr">작성자 : 김석민</p>
				</div>
			</li>
...
<div class="bbsPaz bbsPaz_pd02">
	...
	<div class="bbsBtns_02">
		<a href="talk_01_02_write.asp"><img src="/images/common/btns/write.gif" alt="글쓰기" /></a>
	</div>
	<!-- //버튼영역 (페이징 영역용) -->
</div>
<!-- //페이징 -->
