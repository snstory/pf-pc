...
titleImgSrc = "/images/center/s_title_01.gif"
titleImgMent = "공지사항"
%>
		...
		<tbody>
			...
			<tr>
				...
				<td class="ttle">
					...
					<a href="center_01_view.asp">안녕하세요. 김민경 입니다.</a>
			...
			<tr class="reply">
				<td>1</td>
				<td class="ttle">
					<a href="center_01_view.asp">김민경씨 안녕하세요.^^</a>
					<img src="/images/common/icons/new_02.gif" alt="" class="new" /><!-- 새글일경우 -->
				</td>
				<td>관리자</td>
				<td>10. 01. 29</td>
			...
			<tr>
				<td>2</td>
				<td class="ttle"><a href="center_01_view.asp">안녕하세요. 김민경 입니다.</a></td>
				<td>관리자</td>
				<td>10. 01. 29</td>
				<td>922</td>
			</tr>
